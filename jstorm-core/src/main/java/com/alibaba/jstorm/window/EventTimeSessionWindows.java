 ...
 */
public class EventTimeSessionWindows<T> extends WindowAssigner<T> {
     ...
     * @return The policy.
     */
    public static <T> EventTimeSessionWindows<T> withGap(long size) {
        return new EventTimeSessionWindows<>(size);
    }
