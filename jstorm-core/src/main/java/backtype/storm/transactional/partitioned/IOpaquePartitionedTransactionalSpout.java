...
/**
 * This defines a transactional spout which does NOT necessarily replay the same batch every time
 * it emits a batch for a transaction id.
 */
public interface IOpaquePartitionedTransactionalSpout<T> extends IComponent {
    ...
    interface Emitter<X> {
         ...
         *
         * Return the metadata describing this batch that will be used as lastPartitionMeta for
         * defining the parameters of the next batch.
         */
