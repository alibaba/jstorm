...
public abstract class ConnectionWithStatus implements IConnection {
    ...
    public enum Status {
         ...
         * The new data sending request can be buffered for future sending, or dropped(cases like
        ...
        /**
         * The connection channel is closed or being closed. We don't accept further data sending or receiving.
         * All data sending request will be dropped.
         */
        Closed
    }
