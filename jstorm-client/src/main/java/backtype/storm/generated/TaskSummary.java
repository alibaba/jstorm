...
public class TaskSummary implements org.apache.thrift.TBase<TaskSummary, TaskSummary._Fields>, java.io.Serializable, Cloneable {
  ...
  private TaskStats stats; // optional
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.errors = new ArrayList<ErrorInfo>(_list210.size);
                for (int _i211 = 0; _i211 < _list210.size; ++_i211)
                {
                  ErrorInfo _elem212; // required
                  _elem212 = new ErrorInfo();
                  _elem212.read(iprot);
                  struct.errors.add(_elem212);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TaskSummary struct) throws org.apache.thrift.TException {
      ...
      if (struct.errors != null) {
        oprot.writeFieldBegin(ERRORS_FIELD_DESC);
        {
          ...
          for (ErrorInfo _iter213 : struct.errors)
          {
  ...
  private static class TaskSummaryTupleScheme extends TupleScheme<TaskSummary> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TaskSummary struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.uptime_secs);
      {
        ...
        for (ErrorInfo _iter214 : struct.errors)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TaskSummary struct) throws org.apache.thrift.TException {
      ...
      struct.set_uptime_secs_isSet(true);
      {
        ...
        struct.errors = new ArrayList<ErrorInfo>(_list215.size);
        for (int _i216 = 0; _i216 < _list215.size; ++_i216)
        {
          ErrorInfo _elem217; // required
          _elem217 = new ErrorInfo();
          _elem217.read(iprot);
          struct.errors.add(_elem217);
        }
      }
      struct.set_errors_isSet(true);
