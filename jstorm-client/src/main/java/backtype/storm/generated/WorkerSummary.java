            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tasks = new ArrayList<TaskSummary>(_list226.size);
                for (int _i227 = 0; _i227 < _list226.size; ++_i227)
                {
                  TaskSummary _elem228; // required
                  _elem228 = new TaskSummary();
                  _elem228.read(iprot);
                  struct.tasks.add(_elem228);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WorkerSummary struct) throws org.apache.thrift.TException {
      ...
      if (struct.tasks != null) {
        oprot.writeFieldBegin(TASKS_FIELD_DESC);
        {
          ...
          for (TaskSummary _iter229 : struct.tasks)
          {
  ...
  private static class WorkerSummaryTupleScheme extends TupleScheme<WorkerSummary> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, WorkerSummary struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.topology);
      {
        ...
        for (TaskSummary _iter230 : struct.tasks)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WorkerSummary struct) throws org.apache.thrift.TException {
      ...
      struct.set_topology_isSet(true);
      {
        ...
        struct.tasks = new ArrayList<TaskSummary>(_list231.size);
        for (int _i232 = 0; _i232 < _list231.size; ++_i232)
        {
          TaskSummary _elem233; // required
          _elem233 = new TaskSummary();
          _elem233.read(iprot);
          struct.tasks.add(_elem233);
        }
      }
      struct.set_tasks_isSet(true);
    }
