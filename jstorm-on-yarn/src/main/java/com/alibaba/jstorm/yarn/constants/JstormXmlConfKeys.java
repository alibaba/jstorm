...
public interface JstormXmlConfKeys {
  String PREFIX_PROVIDER = "jstorm.provider";
  /**
   ...
   * {@value}
   */
  String KEY_TEMPLATE_ORIGIN = "jstorm.template.origin";
   ...
   * Slider principal
   */
  String KEY_KERBEROS_PRINCIPAL = "jstorm.kerberos.principal";

  /**
   * Name of the property for ACLs for Slider AM.
   * {@value}
   */
  String KEY_PROTOCOL_ACL = "jstorm.security.protocol.acl";

  /**
   * Limit on restarts for the AM
   * {@value}
   */
  String KEY_AM_RESTART_LIMIT = "jstorm.yarn.restart.limit";

  /**
   * queue name, by default let YARN pick the queue
   */
  String KEY_YARN_QUEUE = "jstorm.yarn.queue";
  String DEFAULT_YARN_QUEUE = null;

  /**
   * default priority
   */
  String KEY_YARN_QUEUE_PRIORITY = "jstorm.yarn.queue.priority";
  int DEFAULT_YARN_QUEUE_PRIORITY = 1;


  /**
   * The jstorm base path: {@value}
   * Defaults to HomeDir/.jstorm
   */
  String KEY_SLIDER_BASE_PATH = "jstorm.base.path";
  ...
  String CLUSTER_DIRECTORY_PERMISSIONS =
    "jstorm.cluster.directory.permissions";
   ...
   */
  String DATA_DIRECTORY_PERMISSIONS = "jstorm.data.directory.permissions";
  ...
  String KEY_AM_LOGIN_KEYTAB_NAME = "jstorm.am.login.keytab.name";
  /** Declare that a keytab must be provided */
  String KEY_AM_LOGIN_KEYTAB_REQUIRED = "jstorm.am.login.keytab.required";
  String KEY_HDFS_KEYTAB_DIR = "jstorm.hdfs.keytab.dir";
  String KEY_AM_KEYTAB_LOCAL_PATH = "jstorm.am.keytab.local.path";
  String KEY_KEYTAB_PRINCIPAL = "jstorm.keytab.principal.name";
  ...
  String KEY_SLIDER_AM_DEPENDENCY_CHECKS_DISABLED =
      "jstorm.am.dependency.checks.disabled";
   ...
   */
  String X_DEV_INSECURE_WS = "jstorm.feature.ws.insecure";
