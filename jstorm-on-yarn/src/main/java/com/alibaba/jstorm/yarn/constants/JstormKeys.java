 ...
 */
public interface JstormKeys extends JstormXmlConfKeys {

    /**
     * This is the name of the slider appmaster in configurations :{@value}
     */
    String COMPONENT_AM = "jstorm-appmaster";
     ...
     */
    String APP_TYPE = "jstormonyarn";

    String APP_HEARTBEAT_TIME = "appHeartBeatTime";

    int HEARTBEAT_TIME_INTERVAL = 20000;
