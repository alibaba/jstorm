 ...
 */
public class TridentTumblingCountWindowTest {

    private final static Logger LOG = LoggerFactory.getLogger(TridentTumblingCountWindowTest.class);
    private WindowConfig windowConfig = TumblingCountWindow.of(1000);
    ...
    {
        private long expectValueType = 1000;
