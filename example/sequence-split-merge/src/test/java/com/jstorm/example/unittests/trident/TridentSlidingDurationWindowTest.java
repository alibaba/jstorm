 ...
 */
public class TridentSlidingDurationWindowTest {

    private final static Logger LOG = LoggerFactory.getLogger(TridentSlidingDurationWindowTest.class);
    private WindowConfig windowConfig = SlidingDurationWindow.of(new BaseWindowedBolt.Duration(6, TimeUnit.SECONDS),
