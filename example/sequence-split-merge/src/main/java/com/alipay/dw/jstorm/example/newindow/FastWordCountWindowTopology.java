 ...
 */
public class FastWordCountWindowTopology {
    private static Logger LOG = LoggerFactory.getLogger(FastWordCountWindowTopology.class);
...
//                count_Parallelism_hint).fieldsGrouping("split", new Fields("word"));
        ...
        builder.setBolt("count", new WordCount().countWindow(20, 10),
                count_Parallelism_hint).fieldsGrouping("split", new Fields("word"));
